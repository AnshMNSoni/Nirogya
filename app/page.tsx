          ...
          <div className="border-t border-gray-200 dark:border-gray-800 py-8 bg-gray-50 dark:bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col sm:flex-row justify-between items-center space-y-6 sm:space-y-0">
                <div className="text-sm text-gray-600 dark:text-gray-400 text-center sm:text-left flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href="https://github.com/AnshMNSoni" target="_blank" rel="noopener noreferrer" className="group">
                      <svg className="h-6 w-6 text-gray-600 dark:text-gray-400 group-hover:text-gray-800 dark:group-hover:text-gray-200 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
